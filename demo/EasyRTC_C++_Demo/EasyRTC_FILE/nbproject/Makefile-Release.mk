...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyrtc_file: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyrtc_file ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/EasyRtcDevice.o: EasyRtcDevice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EasyRtcDevice.o EasyRtcDevice.cpp
...
${OBJECTDIR}/osmutex.o: osmutex.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osmutex.o osmutex.cpp

${OBJECTDIR}/osthread.o: osthread.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osthread.o osthread.cpp
