...
#endif
{
	...
	else if (pThread->flag == THREAD_STATUS_EXIT_EXT)		//��ʾ�Ѵ���, �߳������˳�
	{
		free(pThread);
...
int SetOSThreadName(OSTHREAD_OBJ_T* handle, const char* szFormat, ...)
{
	...
	size_t stacksize = sysconf(_SC_THREAD_STACK_MIN); // ��ȡ��Сջ��С
	pthread_attr_t attr;
	pthread_attr_init(&attr);
	pthread_attr_setstacksize(&attr, stacksize + PTHREAD_STACK_MIN); // ����ջ��С��ȷ�����㹻�Ŀռ���������Ϣ
	pthread_setname_np(szBuf); // �����߳�����
#endif
