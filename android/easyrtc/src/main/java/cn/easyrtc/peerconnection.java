...
public class peerconnection {
    ...
    // Stub methods kept so libEasyRTC.so can find the class and register natives.
    // They are never called from Java — all PC ops use MediaSession.
    ...
    public native int CreateOffer(long peer_connection, long user_ptr);
    public native int SetRemoteDescription(long peer_connection, String sdp);
